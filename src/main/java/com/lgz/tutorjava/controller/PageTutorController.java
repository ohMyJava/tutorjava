...
public class PageTutorController {
    ...
    public Message getTutors(@RequestBody String json){
        ...
        try {
            ...
            msg.setData(pageTutorService.getTutors(able,school,location,page,limit));
    ...
    public Message getOneTutor(Integer tutorId){
        Message msg=Message.getInstance();
        try {
            msg.setData(pageTutorService.getOneTutor(tutorId));
